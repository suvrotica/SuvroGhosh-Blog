...
<main class="bg-white pb-16 pt-8 antialiased lg:pb-24 lg:pt-16 dark:bg-neutral-900">
		...
		>
			<header class="not-format mb-4 lg:mb-6">
				<address class="mb-6 flex items-center not-italic">
					<div class="mr-3 inline-flex items-center text-sm text-neutral-900 dark:text-white">
						<img
						...
						/>
						<div>
							<a href="./" rel="author" class="text-xl font-bold text-neutral-900 dark:text-white"
								>Jese Leos</a
							>
				...
				<h1
					class="mb-4 text-3xl font-extrabold leading-tight text-neutral-900 lg:mb-6 lg:text-4xl dark:text-white"
				>
			...
			<p>
				You can check out the <a href="https://flowbite.com/docs/getting-started/quickstart/"
					>quickstart guide</a
				> to explore the elements by including the CDN files into your project. But if you want to build
				a project with Flowbite I recommend you to follow the build tools steps so that you can purge
				and minify the generated CSS.
			</p>
			<p>
				You'll also receive a lot of useful application UI, marketing UI, and e-commerce pages that
				can help you get started with your projects even faster. You can check out this <a
			...
			<ol>
				<li>
					...
					they follow your intended user journey and buy something from the site you’ve designed? By
					running a usability test, you’ll be able to see how users will interact with your design
					once it’s live;
				</li>
				<li>
					<strong>Involving stakeholders</strong>. Need to check if your GDPR consent boxes are
					displaying properly? Pass your prototype to your data protection team and they can test it
					for real;
				</li>
				<li>
				...
				<li>
					<strong>Communicating your vision</strong>. By using an interactive medium to preview and
					test design elements, designers and developers can understand each other — and the project
					— better.
				</li>
			</ol>
			...
			<p>
				...
				shared across letters. A typeface represents shared patterns across a collection of letters.
			</p>
			<h4>Baseline</h4>
			<p>
				A typeface is a collection of letters. While each letter is unique, certain shapes are
			...
			<h4>Serif</h4>
			<p>
				A serif is a small shape or projection that appears at the beginning or end of a stroke on a
				letter. Typefaces with serifs are called serif typefaces. Serif fonts are classified as one
				of the following:
			</p>
			...
			<pre><code class="language-html"
					>&lt;dl class="grid grid-cols-2 gap-8 max-w-screen-md text-neutral-900 sm:grid-cols-3 dark:text-white"&gt;
  &lt;div class="flex flex-col justify-center items-center"&gt;
    &lt;dt class="mb-2 text-3xl font-extrabold"&gt;73M+&lt;/dt&gt;
    &lt;dd class="text-lg font-normal text-neutral-500 dark:text-neutral-400"&gt;developers&lt;/dd&gt;
  &lt;/div&gt;
  &lt;div class="flex flex-col justify-center items-center"&gt;
    &lt;dt class="mb-2 text-3xl font-extrabold"&gt;1B+&lt;/dt&gt;
    &lt;dd class="text-lg font-normal text-neutral-500 dark:text-neutral-400"&gt;contributors&lt;/dd&gt;
  &lt;/div&gt;
  &lt;div class="flex flex-col justify-center items-center"&gt;
    &lt;dt class="mb-2 text-3xl font-extrabold"&gt;4M+&lt;/dt&gt;
    &lt;dd class="text-lg font-normal text-neutral-500 dark:text-neutral-400"&gt;organizations&lt;/dd&gt;
  &lt;/div&gt;
  &lt;/dl&gt;
  </code></pre>
			<h4>Table example</h4>
			...
			<p>
				<strong>Consider your user</strong>. To create an intuitive user flow, try to think as your
				user would when interacting with your product. While you can fine-tune this during beta
				testing, considering your user’s needs and habits early on will save you time by setting you
				on the right path.
			</p>
			<p>
				...
				focusing on what will be important to your user, like a Buy now button or an image gallery,
				and list each element by order of priority. This way, you’ll be able to create a prototype
			...
			<section class="not-format">
				<div class="mb-6 flex items-center justify-between">
					<h2 class="text-lg font-bold text-neutral-900 lg:text-2xl dark:text-white">
						Discussion (20)
					</h2>
				</div>
				<form class="mb-6">
					<div
						class="mb-4 rounded-lg rounded-t-lg border border-neutral-200 bg-white px-4 py-2 dark:border-neutral-700 dark:bg-neutral-800"
					>
						<label for="comment" class="sr-only">Your comment</label>
						<textarea
							id="comment"
							rows="6"
							class="w-full border-0 px-0 text-sm text-neutral-900 focus:ring-0 dark:bg-neutral-800 dark:text-white dark:placeholder-neutral-400"
				...
				<article class="mb-6 rounded-lg bg-white p-6 text-base dark:bg-neutral-900">
					<footer class="mb-2 flex items-center justify-between">
						<div class="flex items-center">
							<p
								class="mr-3 inline-flex items-center text-sm font-semibold text-neutral-900 dark:text-white"
							>
								<img
						...
						<button
							...
							class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-neutral-500 hover:bg-neutral-100 focus:outline-none focus:ring-4 focus:ring-neutral-50 dark:bg-neutral-900 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:ring-neutral-600"
							type="button"
						>
							<svg
								class="h-4 w-4"
						...
						<div
							id="dropdownComment1"
							class="z-10 hidden w-36 divide-y divide-neutral-100 rounded bg-white shadow dark:divide-neutral-600 dark:bg-neutral-700"
						>
							<ul
					...
					<div class="mt-4 flex items-center space-x-4">
						<button
							type="button"
							class="flex items-center text-sm font-medium text-neutral-500 hover:underline dark:text-neutral-400"
						>
							<svg
				...
				<article class="mb-6 ml-6 rounded-lg bg-white p-6 text-base lg:ml-12 dark:bg-neutral-900">
					<footer class="mb-2 flex items-center justify-between">
						<div class="flex items-center">
							<p
								class="mr-3 inline-flex items-center text-sm font-semibold text-neutral-900 dark:text-white"
				...
				<article
					class="mb-6 border-t border-neutral-200 bg-white p-6 text-base dark:border-neutral-700 dark:bg-neutral-900"
				>
					<footer class="mb-2 flex items-center justify-between">
						<div class="flex items-center">
							<p
							...
							<p class="text-sm text-neutral-600 dark:text-neutral-400">
								<time datetime="2022-03-12" title="March 12th, 2022">Mar. 12, 2022</time>
							</p>
						</div>
						<button
				...
				<article
					class="border-t border-neutral-200 bg-white p-6 text-base dark:border-neutral-700 dark:bg-neutral-900"
				>
					<footer class="mb-2 flex items-center justify-between">
						<div class="flex items-center">
							<p
							...
							<p class="text-sm text-neutral-600 dark:text-neutral-400">
								<time datetime="2022-06-23" title="June 23rd, 2022">Jun. 23, 2022</time>
							</p>
						</div>
						<button
...
<aside aria-label="Related articles" class="bg-neutral-50 py-8 lg:py-24 dark:bg-neutral-800">
	<div class="mx-auto max-w-screen-xl px-4">
		<h2 class="mb-8 text-2xl font-bold text-neutral-900 dark:text-white">Related articles</h2>
		<div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
			<article class="max-w-xs">
				...
				<a
					href="./"
					class="text-primary-600 dark:text-primary-500 inline-flex items-center font-medium underline underline-offset-4 hover:no-underline"
				>
					Read in 2 minutes
				</a>
			</article>
...
<section class="bg-white dark:bg-neutral-900">
	<div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
		<div class="mx-auto max-w-screen-md sm:text-center">
			<h2
				class="mb-4 text-3xl font-extrabold tracking-tight text-neutral-900 sm:text-4xl dark:text-white"
			>
				Sign up for our newsletter
			</h2>
			<p class="mx-auto mb-8 max-w-2xl text-neutral-500 sm:text-xl md:mb-12 dark:text-neutral-400">
			...
			<form action="./">
				<div class="mx-auto mb-3 max-w-screen-sm items-center space-y-4 sm:flex sm:space-y-0">
					<div class="relative w-full">
						<label
							for="email"
							class="mb-2 hidden text-sm font-medium text-neutral-900 dark:text-neutral-300"
							>Email address</label
						>
						...
						<input
							class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-neutral-300 bg-white p-3 pl-9 text-sm text-neutral-900 sm:rounded-none sm:rounded-l-lg dark:border-neutral-600 dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-400"
					...
					<div>
						<button
							type="submit"
							class="bg-primary-700 border-primary-600 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 w-full cursor-pointer rounded-lg border px-5 py-3 text-center text-sm font-medium text-white focus:ring-4 sm:rounded-none sm:rounded-r-lg"
							>Subscribe</button
						>
					</div>
				</div>
				<div
					class="newsletter-form-footer mx-auto max-w-screen-sm text-left text-sm text-neutral-500 dark:text-neutral-300"
				>
...
<footer class="bg-neutral-50 antialiased dark:bg-neutral-800">
	<div class="mx-auto max-w-screen-xl p-4 py-6 md:p-8 lg:p-10">
		<div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
			...
			<div>
				<h2 class="mb-6 text-sm font-semibold uppercase text-neutral-900 dark:text-white">Legal</h2>
				<ul class="text-neutral-500 dark:text-neutral-400">
					<li class="mb-4">
		...
		<div class="text-center">
			<a
				href="./Blog.svelte"
				class="mb-5 flex items-center justify-center text-2xl font-semibold text-neutral-900 dark:text-white"
			>
			...
			<span class="block text-center text-sm text-neutral-500 dark:text-neutral-400"
